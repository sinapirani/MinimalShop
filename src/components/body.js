...
export function Body(){
  ...
  return(
      <div className=" w-screen min-h-screen">
          ...
          <div id="footer" className=" w-5/6 fixed h-24 bg-white shadow-slate-400 m-auto inset-x-0 bottom-9 rounded-3xl flex justify-between items-center">

                <div onClick={()=>{setPage('cat')}} className=" w-1/3 p-0 flex justify-center items-center">
                ...
                <svg id="cat" ref={cat} className=" fill-transparent h-8 w-8" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M16.2856 2H19.5522C20.9037 2 22.0001 3.1059 22.0001 4.47018V7.7641C22.0001 9.12735 20.9037 10.2343 19.5522 10.2343H16.2856C14.933 10.2343 13.8367 9.12735 13.8367 7.7641V4.47018C13.8367 3.1059 14.933 2 16.2856 2Z" stroke="#200E32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M4.44892 2H7.71449C9.06703 2 10.1634 3.1059 10.1634 4.47018V7.7641C10.1634 9.12735 9.06703 10.2343 7.71449 10.2343H4.44892C3.09638 10.2343 2 9.12735 2 7.7641V4.47018C2 3.1059 3.09638 2 4.44892 2Z" stroke="#200E32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M4.44892 13.7657H7.71449C9.06703 13.7657 10.1634 14.8716 10.1634 16.2369V19.5298C10.1634 20.8941 9.06703 22 7.71449 22H4.44892C3.09638 22 2 20.8941 2 19.5298V16.2369C2 14.8716 3.09638 13.7657 4.44892 13.7657Z" stroke="#200E32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M16.2856 13.7657H19.5522C20.9037 13.7657 22.0001 14.8716 22.0001 16.2369V19.5298C22.0001 20.8941 20.9037 22 19.5522 22H16.2856C14.933 22 13.8367 20.8941 13.8367 19.5298V16.2369C13.8367 14.8716 14.933 13.7657 16.2856 13.7657Z" stroke="#200E32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <p ref={catText} className=" transition-all duration-75 ease-in  text-black font-extrabold ml-1">Category</p>
                </Link>
                </div>  

              
                <div onClick={()=>{setPage('home')}} className=" w-1/3 flex justify-center items-center">
                <Link className="w-full h-full flex flex-row justify-center items-center" to={'/'}>
                  ...
                  <p ref={homeText} className=" text-black font-extrabold ml-1">Explore</p>
                </Link>
                </div>

              
                <div onClick={()=>{setPage('profile')}} className=" w-1/3 flex justify-center items-center">
                  <Link className="w-full h-full flex flex-row justify-center items-center" to={'/profile'}>
                <svg id="profile" ref={profile} className=" fill-transparent h-8 w-8" width="24" height="24" viewBox="0 0 24 24" fill="current" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="11.5791" cy="7.27803" r="4.77803" stroke="#200E32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <p ref={profileText} className=" text-black font-extrabold ml-1">Profile</p>
                  </Link>
                </div>
